...
// # Project: Yarr
// # Description: Fei4 CrossTalk
// # Comment: Nothing fancy
// ################################

#include "Fei4CrossTalkScan.h"

Fei4AnalogScan::Fei4CrossTalkScan(Fei4 *fe, TxCore *tx, RxCore *rx, ClipBoard<RawDataContainer> *data) : ScanBase(fe, tx, rx, data) {
    mask = MASK_32;
    dcMode = QUAD_DC;
    numOfTriggers = 100;
...
Fei4AnalogScan::Fei4CrossTalkScan(Bookkeeper *k) : ScanBase(k) {
    mask = MASK_32;
    dcMode = QUAD_DC;
    numOfTriggers = 100;
    triggerFrequency = 20e3;
